...
var $lineTab = $('.tab-component__tab');
var $buttonMore = $('.lines .opti-btn-3--dark-green');
var $mainProductSlider = $('.main-product-slider');
var $mainNavProductSlider = $('.product-nav-slider');
var $productGallery = $('.product-gallery');
var $cityBtn = $('#mirs-city-input');
var $cityList = $('.search-city__list');
var $cityItem = $('.search-city__list-item');
var $noResultItem = $('.search-city-no-result');
var $body = $('body');
var hideClass = 'd-none';
var hideMdClass = 'd-md-none';
var openClass = 'open';
var overflowClass = 'overflow-hidden';
var openGalleryClass = 'open-gallery';
var selectedClass = 'selected';
var slickIndexAttr = 'data-slick-index';
var initialSlideIndex = $mainProductSlider.attr('data-has-video') === 'true' ? 1 : 0;
...
$lineTab.on('click', function () {
  ...
  $(this).addClass(activeClass).closest('section.tab-component:not(.bkt-tabs)').find('.tab-component__inner').addClass(hideClass).eq($(this).index()).removeClass(hideClass);
  $(this).closest('section.bkt-tabs.tab-component').find('.tab-component__inner').addClass(hideMdClass).eq($(this).index()).removeClass(hideMdClass);
});
...
$(document).ready(function () {
  ...
  $buttonMore.on('click', function () {
    $(this).addClass(hideClass).closest('section.lines .lines__inner').eq($(this).index()).find('.lines__inner-item.d-none').removeClass(hideClass);
  });
  ...
  $('.why-block__item, .mirs-product-rating').on('click', function () {
    ...
    window.scrollTo({
      top: $($(this).attr('data-anchor')).offset().top - offset,
      behavior: 'smooth'
    });
  });
  ...
  $(document).on('click', '#select-city', function () {
    var cityName = $('.selected').attr('data-city');
  ...
  $(document).on('click', '#select-delivery-city', function (e) {
    var $this = $(this);
    var $selectModal = $('.select-city-modal');
  ...
  $cityBtn.keyup(function () {
    var $cityBtnVal = $(this).val().toUpperCase();
...
/***/ "./resources/scss/vendors/slick.scss":
/*!*******************************************!*\
  !*** ./resources/scss/vendors/slick.scss ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["public/css/slick","public/css/app"], () => (__webpack_require__("./resources/js/script.js")))
/******/ 	__webpack_require__.O(undefined, ["public/css/slick","public/css/app"], () => (__webpack_require__("./resources/scss/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/slick","public/css/app"], () => (__webpack_require__("./resources/scss/vendors/slick.scss")))
