...
var $burgerAndMenu = $('.burger, .header-mobile-menu');
var $searchInput = $('.mirs-search-input');
var searchTimeOut;
...
$(document).ready(function () {
  ...
  $(document).on('click', function (e) {
    var menu = $('#header, .header-mobile-menu-inner, .header-mobile-bottom');
  ...
  $('.menu-item-tab').on('click', function (e) {
    ...
    $(".menu-".concat($this.attr('data-tab'), "-content")).addClass(activeClass);
  });
  ...
  $('.mirs-search-btn').on('click', function () {
  ...
  $searchInput.on('input', function () {
    ...
    var $searchResultItem = $('.search-result-wrapper a');
    if (value.length > 2) {
      searchTimeOut = setTimeout(function () {
        // request must be here
        $searchResult.show();
        var newItemText = $searchResultItem.text().replace(value, "<span class=\"search-word\">".concat(value, "</span>"));
  ...
  $('.search-icon, .search-result__btn').on('click', function () {
    if ($searchInput.val().trim().length > 2) location.href = "/search?search=".concat($searchInput.val().trim());
  });
  $('.footer-links__btn').on('click', function () {
